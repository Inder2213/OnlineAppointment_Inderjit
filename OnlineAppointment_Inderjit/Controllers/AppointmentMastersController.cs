...
using OnlineAppointment_Inderjit.Models;

namespace OnlineAppointment_Inderjit.Controllers
{
    public class AppointmentMastersController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.SlotTimeMasterID = new SelectList(db.SlotTimeMasters, "ID", "SlotDateTime");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ID,ServiceMasterID,CustomerMasterID,SlotTimeMasterID,Date")] AppointmentMaster appointmentMaster)
        {
            ...
            ViewBag.SlotTimeMasterID = new SelectList(db.SlotTimeMasters, "ID", "SlotDateTime", appointmentMaster.SlotTimeMasterID);
            return View(appointmentMaster);
        }
